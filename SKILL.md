...
- [NWC Client: Interact with a wallet to do things like sending and receive payments](./references/nwc-client/README.md)
- [Lightning Tools: Request invoices from a lightning address or do bitcoin <-> fiat conversions](./references/lightning-tools/README.md)
